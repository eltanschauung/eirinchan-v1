...
if ($('html').hasClass('mobile-style')) {
	device_type = "mobile";
}
else if ($('html').hasClass('desktop-style')) {
	device_type = "desktop";
}
else if(navigator.userAgent.match(/iPhone|iPod|iPad|Android|Opera Mini|Blackberry|PlayBook|Windows Phone|Tablet PC|Windows CE|IEMobile/i)) {

defmodule EirinchanWeb.BoardChrome do
  ...
  def for_board(%{uri: "bant"}) do
    %{
      ...
      top_news_html: bant_news_html(),
      post_form_blotter_html:
        ~s|<div class="blotter">/trp/ - Touhou Roleplay - Valentine's Day (Feb. 14th)</div>|,
      footer_html: bant_footer_html(),
      search_links: [
        %{href: "/bant/catalog.html", label: "[Orin]"},
        %{href: "https://archive.is/bantculture.com", label: "[Archive]"}
      ],
      show_default_announcement: false
    }
  end

defmodule EirinchanWeb.PostView do
  ...
  def post_number_links_html(post_id, post_href, quote_href, attrs \\ []) do
    ...
    ~s|&nbsp;<a class="post_no" id="post_no_#{post_id}" onclick="highlightReply(#{post_id})" href="#{html_escape_to_string(post_href)}">No.</a><a class="post_no" onclick="return citeReply(#{post_id})" href="#{html_escape_to_string(quote_href)}"#{quote_attrs}>#{post_id}</a>|
  end
